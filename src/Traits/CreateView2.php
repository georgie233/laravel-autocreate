...
trait CreateView2
{
    protected function createIndexBlade()
    {
        ...
        $content = $this->replaceVars(__DIR__."/../Build2/views/index.blade.php");
...
//                $title =
        ...
        $this->setVar('COLUMNS_VALUE', $COLUMNS_VALUE);
        $content = $this->replaceVars(__DIR__."/../Build2/views/mobile.blade.php");
    ...
    protected function createCreateAndEditBlade()
    {
        ...
        if ( ! is_file($file)) {
            ...
            $content = $this->replaceVars(__DIR__.'/../Build2/views/create.blade.php');
        ...
        if ( ! is_file($file)) {
            $this->info('create.blade.php view create successflly');
            $content = $this->replaceVars(__DIR__.'/../Build2/views/edit.blade.php');
    ...
    {
        $file = __DIR__.'/../Build2/forms/input.blade.php';
    ...
    {
        $file = __DIR__.'/../Build2/forms/textarea.blade.php';
    ...
    {
        $file = __DIR__.'/../Build2/forms/date.blade.php';
    ...
    {
        $file = __DIR__.'/../Build2/forms/datetime.blade.php';
    ...
    {
        $file = __DIR__.'/../Build2/forms/simditor.blade.php';
    ...
    {
        $file = __DIR__.'/../Build2/forms/image.blade.php';
...
str;
        ...
        if ($content) {
            ...
            $file = __DIR__.'/../Build2/forms/checkbox.blade.php';
...
str;
        ...
        if ($content) {
            $this->setVar('FORM_HTML', $content);
            $file = __DIR__.'/../Build2/forms/select.blade.php';
...
str;
        ...
        if ($content) {
            $this->setVar('FORM_HTML', $content);
            $file = __DIR__.'/../Build2/forms/radio.blade.php';
